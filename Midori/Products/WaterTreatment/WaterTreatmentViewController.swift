//
//  WaterTreatmentViewController.swift
//  Emiir
//
...
class WaterTreatmentViewController: UIPageViewController , UIPageViewControllerDataSource, UIPageViewControllerDelegate
{
    private(set) lazy var orderedViewControllers: [UIViewController] =
    {
        return [self.newProdectViewController("Display_product_Image", strImageName: "water_treatment_1"),
                self.newProdectViewController("Display_product_Image", strImageName: "water_treatment_2")]
    }()
