...
class HomeEquipmentViewController: UIPageViewController , UIPageViewControllerDataSource, UIPageViewControllerDelegate
{
    ...
    {
        return [self.newColoredViewController("Display_product_Image", strImageName: "home_equipment_1"),
                self.newColoredViewController("Display_product_Image", strImageName: "home_equipment_2")]
    }()
